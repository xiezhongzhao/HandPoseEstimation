...
def main():
    ...
    ### MSRA
    eval_names = ['ResNet-Hand', '3DCNN', 'Multi-Region',
                  'Pose-Guide']

    eval_files = [dir + 'results/msra/JVCI18_MSRA_REN_9x6x6.txt',
...
# python src/compute_error.py nyu max-frame DeepPrior results/nyu/CVWW15_NYU_Prior.txt